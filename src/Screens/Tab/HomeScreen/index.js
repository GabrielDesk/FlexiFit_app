...
const HomeScreen = () => {
  ...
  //       // Atualizar a posição do componente flutuante durante o movimento
  ...
  //  const nextImage = () => {
  //    setCurrentIndex((prevIndex) => (prevIndex + 1) % backgroundImagePB.length);
  //  };

  //  const prevImage = () => {
  //    setCurrentIndex((prevIndex) => (prevIndex - 1 + backgroundImagePB.length) % backgroundImagePB.length);
  //  };
  ...
  //  useEffect(() => {
  //     console.log({backgroundImagePB});
  //     checkLoadMore();

  //   }, [backgroundImagePB])

  //  async function Mount() {
  //     // await Promise.all([getImageToBackground(), getUnsplashImageToBackground()]);
  //     await Promise.all([getImageToBackground()]);
  //  }

  //  async function getImageToBackground() {
  //     try {
  //       const response = await getImagesFromPixBay();
  ...
  //           setBackgroundImagePB((prevImages) => [...prevImages, ...newImages]);
  //         } else {
  //           console.log("Sem novas imagens disponíveis");
  //         }
  //       } else {
  //         console.log("Algo de errado aconteceu ao obter novas imagens");
  //       }
  //     } catch (error) {
  ...
  //   async function getUnsplashImageToBackground(paramPage = 1) {
  //     try {
  //       const response = await getRandomImagesFromUnsplash(paramPageIndicator);

  //       if (response.success) {
  //         const newImages = response.data;
  //         console.log("unsplash: ", newImages.urls);
  ...
  //    // Verificar se todas as imagens foram exibidas
  //     if (currentIndex === backgroundImagePB.length - 1) {
  //       setParamPageIndicator((prevValue) => prevValue + 1);
  //       // await getUnsplashImageToBackground();
  //       await getImageToBackground();
  //       } else {
